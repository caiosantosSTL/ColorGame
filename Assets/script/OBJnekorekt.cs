...
public class OBJnekorekt : MonoBehaviour {
    ...
    public static int STGincorret; //string nombre incorrecto
    public Text tcolor;
    int vrandd; //valor random
    int distanc = 2; //distancia de posicion del objeto
    int distanc2 = 3;
    int subir = 4; // distancia para subir los objetos
   ...
   //int counter = valcont;
    ...
    IEnumerator atraso_ativar_colider()// tiempo para reactivar render y colider de los objetos
    {
        ...
        RelojRegresiv.contador += 1; // ponemos + 4 en el reloj por los segundos que los objetos quedaran inactivos
